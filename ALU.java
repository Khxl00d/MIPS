public class ALU {
    ...
    public int ALUOutput(int readData1, int readData2, int ALUCont){
        switch(ALUCont){
            ...
            case 4: result = readData1 - readData2; if(result > 0){result = 1;} else{ result = 0;} break;
            case 5: result = ~(readData1 | readData2); break;
            //assume readData2 is shamt, readData1 is rt
            case 6: result = readData1 << readData2; break;
            default:
                result = 0;
        }
        return result;
